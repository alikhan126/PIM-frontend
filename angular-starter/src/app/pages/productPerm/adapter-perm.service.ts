...
add (record: any): Observable<any> {
  ...
  return this.http.post<any>(`${AppConfig.URL_AdaptersPermission}`, record).pipe(
    map(x => x ),
...
getAll() 
{
  ...
  return this.http.get<any []>(`${AppConfig.URL_AdaptersPermission}`)
  .pipe(
    map(x => x ),
...
get(id){
  return this.http.get<any>(`${AppConfig.URL_AdaptersPermission}${id}/`).pipe(
    map(x => x ),
...
//   const url = `${AppConfig.URL_AdaptersPermission}${id}`;
...
update (record: any): Observable<any> {
  return this.http.put(`${AppConfig.URL_AdaptersPermission}${record["id"]}/`, record).pipe(
...
delete(id){
  return this.http.delete<any>(`${AppConfig.URL_AdaptersPermission}${id}/`).pipe(
    map(x => x ),
