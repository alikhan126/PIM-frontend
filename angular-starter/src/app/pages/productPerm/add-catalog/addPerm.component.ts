...
import { PermissionService } from '../catalog-perm.service';
...
export class AddCatalogPermComponent implements OnInit{
  ...
  goToRoles(){
    this.router.navigate(['/fields/catalog']);
