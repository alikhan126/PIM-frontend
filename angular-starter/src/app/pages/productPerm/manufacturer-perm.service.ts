...
add (record: any): Observable<any> {
  ...
  return this.http.post<any>(`${AppConfig.URL_ManufacturerPermission}`, record).pipe(
    map(x => x ),
...
getAll() 
{
  ...
  return this.http.get<any []>(`${AppConfig.URL_ManufacturerPermission}`)
  .pipe(
    map(x => x ),
...
get(id){
  return this.http.get<any>(`${AppConfig.URL_ManufacturerPermission}${id}/`).pipe(
    map(x => x ),
...
//   const url = `${AppConfig.URL_ManufacturerPermission}${id}`;
...
update (record: any): Observable<any> {
  return this.http.put(`${AppConfig.URL_ManufacturerPermission}${record["id"]}/`, record).pipe(
...
delete(id){
  return this.http.delete<any>(`${AppConfig.URL_ManufacturerPermission}${id}/`).pipe(
    map(x => x ),
