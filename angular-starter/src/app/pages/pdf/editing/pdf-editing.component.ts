...
@Component({
    ...
    templateUrl: './pdf-editing.component.html',
    styleUrls: ['./pdf-editing.component.scss']
})
...
export class PDFEditComponent {
    ...
    constructor(private toastService:NGXToastrService, private modalService: NgbModal, private pdfService: PdfService, private router: Router) {
    }
    ngOnInit() {
        this.getUserRole();
