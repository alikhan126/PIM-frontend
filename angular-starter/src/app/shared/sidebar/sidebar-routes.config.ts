...
export const ROUTES: RouteInfo[] = [
    ...
    },
    {
        ...
        submenu: [
            ...
            { path: '', title: 'Roles', icon: '', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false, submenu: [
                { path: '/roles', title: 'Permissions', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
